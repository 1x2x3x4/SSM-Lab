...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form name="form2" method="post" class="form-x" action="${pageContext.request.contextPath}/admin/addAdmin">
      <div class="form-group">
        <div class="label">
          <label for="sitename">姓 名：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="" id="username" name="username" size="50" placeholder="请输入姓名" data-validate="required:请输入姓名" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input id="password" name="password" type="password" value=""  class="input w50" placeholder="请输入密码" size="50" data-validate="required:请输入密码,length#>=5:密码不能小于5位" />
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="password" class="input w50" name="password2" size="50" placeholder="请再次输入新密码" data-validate="required:请再次输入新密码,repeat#password2:两次输入的密码不一致" />
        </div>
      </div>
      <div class="form-group">
        <div class="label">
