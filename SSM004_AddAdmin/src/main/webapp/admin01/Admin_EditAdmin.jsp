...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${pageContext.request.contextPath}/admin/updateAdminById">
      <div class="form-group">
        ...
        <div class="field">
          ...
          <input id="username" type="text" class="input w50" name="username" value="${admin.username}" size="50" placeholder="请输入姓名" data-validate="required:请输入姓名" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input id="password" type="text" class="input w50" name="password" value="${admin.password}"  size="50" placeholder="请输入密码" data-validate="required:请输入密码,length#>=5:密码不能小于5位" />
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input id="password2" type="text" class="input w50" name="password2" value="${admin.password}" size="50" placeholder="请再次输入新密码" data-validate="required:请再次输入新密码,repeat#adminPwd:两次输入的密码不一致" />
        </div>
      </div>
