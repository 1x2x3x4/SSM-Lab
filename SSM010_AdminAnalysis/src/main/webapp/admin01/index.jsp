...
<div class="leftnav">
    ...
    <ul style="display: block;">
        <li><a href="${pageContext.request.contextPath}/toAddAdmin" target="right">
       ...
       <li><a href="${pageContext.request.contextPath}/toAnalysis" target="right">
            <span class="icon-caret-right"></span>管理员分析
        </a></li>
    </ul>

    <h2>
        <span class="icon-pencil-square-o"></span>新闻栏目管理
    </h2>
    <ul style="display: none;">
        <li><a href="${pageContext.request.contextPath}/toAddNewsType" target="right">
            <span class="icon-caret-right"></span>添加新闻栏目
        </a></li>
        <li><a href="${pageContext.request.contextPath}/findAllNewsType?pagenum=1" target="right">
            <span class="icon-caret-right"></span>新闻栏目列表
        </a></li>
    </ul>
    ...
    <ul style="display: none;">
        <li><a href="${pageContext.request.contextPath}/toAddNews" target="right">
            <span class="icon-caret-right"></span>添加新闻
        </a></li>
        <li><a href="${pageContext.request.contextPath}/findAllNews?pagenum=1" target="right">
            <span class="icon-caret-right"></span>新闻列表
        </a></li>
    </ul>
