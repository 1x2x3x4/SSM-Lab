...
<body>
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong><span class="icon-key"></span> 添加新闻</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x"
				action="${pageContext.request.contextPath}/news/addNews">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" name="title" size="50"
							placeholder="请输入新闻标题" data-validate="required:请输入新闻标题" /> <input
							type="hidden" class="input w50" name="method" size="50"
							placeholder="请输入新闻标题" value="addNews" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="field">
						<input name="author" type="text" class="input w50" id="author"
							placeholder="请输入发布作者" size="50" data-validate="required:请输入发布作者" />
					</div>
				</div>
				...
				<div class="form-group">
			      ...
			      <%
if ((String)request.getAttribute("add") == "success") { %>
    <script>
    alert("添加成功！");
