...
<body style="background-color: #f2f9fd;">
	<div class="header bg-main">
		<div class="logo margin-big-left fadein-top">
			<h1>
				<img src="${pageContext.request.contextPath}/admin01/images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />新闻后台管理系统
			</h1>
		</div>
		<div class="head-l" style="float: right; margin-right: 2%;">
			<span style="color: white"><span style="color: lightblue">${message}</span>登录</span> 
			<span style="margin-left: 20px; margin-right: 30px; color: white">身份：<span style="color: lightblue;">管理员</span></span>
				<a class="button button-little bg-red" href="${pageContext.request.contextPath}/admin01/login.jsp"><span class="icon-power-off"></span> 退出登录</a>
		</div>
	</div>
	...
	<div class="leftnav">
		...
		<ul style="display: block;">
			...
			<li><a href="${pageContext.request.contextPath}/admin/findAdmin?pagenum=1" target="right"> 
